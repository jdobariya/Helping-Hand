...
const users_data = [
  {
    ...
    skills: ["Patience", "Self-regulation", "Humility", "Tact", "Celebration"],
  ...
  },
  {
    ...
    skills: ["Assertiveness", "Self-confidence", "Communication", "Diplomacy"],
  ...
  },
  {
    ...
    password: "Test@1234",
    bio: "I'm a teacher who loves to inspire and educate young minds.",
    skills: ["Assertiveness", "Self-awareness", "Patience", "Open-mindedness"],
    address: "5 Kim Pass",
    isHost: false,
  },
  {
  ...
  },
  {
    ...
    password: "Test@1234",
    bio: "I'm a history buff who enjoys learning about different cultures and civilizations.",
    skills: ["Self-awareness", "Empowerment", "Self-regulation", "Motivation"],
...
async function seedUsers() {
  for (let i = 0; i < users_data.length; i++) {
    let first_name = users_data[i].first_name;
    let last_name = users_data[i].last_name;
    let email = users_data[i].email;
    let password = users_data[i].password;
    let isHost = users_data[i].isHost;
    let contact = users_data[i].contact;
    let bio = users_data[i].bio;
    let skills = users_data[i].skills;
    let address = users_data[i].address;
    try {
...
async function seedEvents() {
  for (let i = 0; i < events_data.length; i++) {
    let event_name = events_data[i].event_name;
    let description = events_data[i].description;
    let application_deadline = events_data[i].application_deadline;
    let host_time = events_data[i].host_time;
    let location = events_data[i].location;

    try {
      let host_info = host_info_list[getRandomInt(host_info_list.length)];
      console.log(host_info_list.length);
